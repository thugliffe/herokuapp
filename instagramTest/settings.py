...
ADMINS = (
     ('Biru C. Sainju', 'sainju.biru@gmail.com'),
)

MANAGERS = ADMINS
CLIENT_ID='b55b44c25e2c4e42acf18400fe0b233c'
CLIENT_SECRET='05649213aa354714913fc0c124bd6509'
...
REDIRECT_URI='http://127.0.0.1:8000/instagram/auth/'
DATABASES = {
    'default': {
...
SECRET_KEY = '#6mb*_*@2h(7qbnut8n2p^_3o@bpts5bx3vi!ne#kqqs@wuc-j'
...
ROOT_URLCONF = 'instagramTest.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'instagramTest.wsgi.application'
